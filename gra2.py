...
class Player():
    ...
    def draw(self, screen):
        ...
        pygame.draw.rect(screen, BLUE, self.rect_75, self.rect_75_size)
        pygame.draw.rect(screen, GREEN, self.rect_50, self.rect_50_size)
        pygame.draw.circle(screen, RED, self.rect.center, self.rect.width / 2, self.circle_size)
